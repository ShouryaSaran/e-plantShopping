            ...
            {!showCart ? (
                <div className="product-grid">
                   ...
                   {plantsArray.map((plants) => (
                        <>
                            <h2 className='category'>{plants.category}</h2>
                            <div className='product-list'>
                            {plants.plants.map((plant , index) => (
                                <div className='product-card' key={index}>
                                    <h4 className='product-title'>{plant.name}</h4>
                                    <img src={plant.image} alt={plant.name} width='200' className='product-image'/>
                                    <p>{plant.description}</p>
                                    <p className='product-price'>{plant.cost}</p>
                                    <button className='product-button' onClick={() => handleAddToCart(plant)}>
                                        {cart.find(item => item.name === plant.name)?"Added To Cart" : "Add To Cart"}</button>
                                </div>
                            ) )}
                            </div>
